...
class Button(UIComponent):
    ...
    def update(self, dt: float) -> None:
        ...
        '''
        if self.hitbox.collidepoint(input_manager.mouse_pos):
            self.img_button_default = self.img_button_hover
            if input_manager.mouse_pressed(1) and self.on_click is not None:
                self.on_click()
        else:
            self.img_button_default = self.img_button
        pass
...
class Slide_Button(UIComponent):
    img_button: Sprite
    img_button_default: Sprite
    img_button_hover: Sprite
    hitbox: pg.Rect
...
class OnOff_Button(UIComponent):
    img_button: Sprite
    img_button_default: Sprite
    img_button_hover: Sprite
    hitbox: pg.Rect
    ...
    def update(self, dt: float) -> None:
        ...
        if self.hitbox.collidepoint(input_manager.mouse_pos) and input_manager.mouse_pressed(1):
            (self.img_button,self.img_button_hover) = (self.img_button_hover,self.img_button)
            self.on_click()
        pass
...
class Hover_Picture(UIComponent):
    img_button: Sprite
    hitbox: pg.Rect
    on_click: Callable[[], None] | None
